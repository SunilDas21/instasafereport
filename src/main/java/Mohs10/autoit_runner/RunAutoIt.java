...
public class RunAutoIt {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            htmlReport.write("<html><head><title>AutoIt Test Report</title>");

            htmlReport.write("<style>");

            htmlReport.write("body {text-align: center;}");

            htmlReport.write("table {margin: 0 auto;}");

            htmlReport.write("th, td {padding: 10px; text-align: center;}");

            htmlReport.write("</style>");

            htmlReport.write("</head><body>");
